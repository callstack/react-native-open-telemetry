...
const counter = meter.createCounter("my-js-counter", { description: "A counter metric for my JS app" });
    ...
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', gap: 32 }}>
      ...
      <Pressable 
        ...
        onPress={async () => {
          ...
          parentSpan.setAttributes({ platform: "js", userId: 123, userType: "admin" });
      ...
      <Pressable
        ...
        onPress={() => {
          ...
          counter.add(1, { platform: "js", userId: "test-user-id", plan: Math.random() < 0.5 ? "basic" : "paid" });
        }}
      >
